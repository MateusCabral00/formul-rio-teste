...
class PassagemForms(forms.ModelForm):
    ...
    class Meta:
        ...
        labels = {'data_ida': 'Data de ida',
                  'data_volta': 'Data de Volta', 'informacoes': 'Informações extras', 'classe_viagem': 'Classe do vôo'}
        widgets = {
            'data_ida': DatePicker(),
    ...
    def clean(self):
        ...
        validacao_datas(data_ida, data_volta, lista_de_erros)
        validacao_data_pesquisa(data_ida, data_pesquisa, lista_de_erros)
